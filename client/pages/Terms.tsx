          ...
          <CardContent className="space-y-6 pt-6">
            ...
            <section>
              ...
              <p className="text-slate-300">
                ...
                majority in your jurisdiction) to use CrownPlay. By using our
            ...
            <section>
              ...
              <ul className="text-slate-300 space-y-2 list-disc list-inside">
                ...
                <li>
                  Coins do not expire and maintain their value indefinitely
                </li>
                <li>
                  We reserve the right to adjust coin values or availability
                </li>
                <li>
                  Promotional bonuses are subject to specific terms and
                  conditions
                </li>
              </ul>
            </section>
            ...
            <section>
              <h2 className="text-2xl font-bold text-white mb-3">
                5. Fair Play and Games
              </h2>
              <p className="text-slate-300">
                All games use certified random number generators and are
                regularly audited. The RTP (Return to Player) percentage for
                each game is displayed and represents the long-term expected
                payout. CrownPlay prohibits cheating, collusion, and fraudulent
                activity.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-slate-300 mb-3">
                CrownPlay is committed to responsible gaming. We encourage
                players to:
              </p>
              <ul className="text-slate-300 space-y-2 list-disc list-inside">
            ...
            <section>
              ...
              <p className="text-slate-300">
                CrownPlay is provided "as is" without warranties. We are not
                liable for any indirect, incidental, or consequential damages
                arising from your use of our service. Your remedy is limited to
                the amount paid through our service.
              </p>
            </section>
            ...
            <section>
              ...
              <p className="text-slate-300">
                ...
                violations of these terms, illegal activity, or for any reason
                at our discretion. Upon termination, your right to use the
